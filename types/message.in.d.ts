...
declare namespace IncomingMessage {
  ...
  /** {@link Idle.Jishi.ActivityItemEvent 闲鱼电商Saas > 无忧卖商品活动变更消息} */
  ...
  /** {@link Idle.Seller.JishiAiGenerateItemDesc 闲鱼电商Saas > 无忧卖活动商品ai生成商品标描} */
  type IdleSellerJishiAiGenerateItemDesc = Message & { content?: MessageContent & { topic?: 'idle_seller_JishiAiGenerateItemDesc', content?: string | Idle.Seller.JishiAiGenerateItemDesc } };
  ...
  /** {@link Taobao.Ofn.BindWaybillResult 服务市场 > 以旧换新顺丰直连绑定结果通知} */
  type TaobaoOfnBindWaybillResult = Message & { content?: MessageContent & { topic?: 'taobao_ofn_BindWaybillResult', content?: string | Taobao.Ofn.BindWaybillResult } };
  /** {@link Taobao.Ofn.CreditPayStatusChange 服务市场 > 信用代扣状态变更同步} */
  ...
  /** {@link Taobao.Ofn.DifferenceRefundPay 服务市场 > 消费者补贴追差付款完成通知} */
  ...
  /** {@link Taobao.Ofn.NewOrderEventSync 服务市场 > 以旧换新新机单事件同步} */
  ...
  /** {@link Taobao.Ofn.OrderStatusSync 服务市场 > 以旧换新回收单状态同步} */
  ...
  /** {@link Taobao.Ofn.QaAmountConfirm 服务市场 > 以旧换新质检价格通知} */
  ...
  /** {@link Taobao.Ofn.RateSync 服务市场 > 以旧换新回收单评价消息} */
  ...
  /** {@link Taobao.Retrieve.Started 淘宝退款 > 开始商家挽回消息} */
  type TaobaoRetrieveStarted = Message & { content?: MessageContent & { topic?: 'taobao_retrieve_Started', content?: string | Taobao.Retrieve.Started } };
  ...
  /**
   * - {@link IdleJishiActivityItemEvent 闲鱼电商Saas > 无忧卖商品活动变更消息}
   */
   ...
   * - {@link IdleSellerJishiAiGenerateItemDesc 闲鱼电商Saas > 无忧卖活动商品ai生成商品标描}
   * - {@link IdleSellerProShopStatus 闲鱼电商Saas > 闲鱼鱼小铺专业号身份变更状态}
   */
  type IdleSeller = IdleSellerImprovePackOrder
    | IdleSellerJishiAiGenerateItemDesc
  ...
  /**
   * - {@link TaobaoOfnBindWaybillResult 服务市场 > 以旧换新顺丰直连绑定结果通知}
   * - {@link TaobaoOfnCreditPayStatusChange 服务市场 > 信用代扣状态变更同步}
   * - {@link TaobaoOfnDifferenceRefundPay 服务市场 > 消费者补贴追差付款完成通知}
   * - {@link TaobaoOfnNewOrderEventSync 服务市场 > 以旧换新新机单事件同步}
   * - {@link TaobaoOfnOrderStatusSync 服务市场 > 以旧换新回收单状态同步}
   * - {@link TaobaoOfnQaAmountConfirm 服务市场 > 以旧换新质检价格通知}
   * - {@link TaobaoOfnRateSync 服务市场 > 以旧换新回收单评价消息}
   */
  type TaobaoOfn = TaobaoOfnBindWaybillResult
    | TaobaoOfnCreditPayStatusChange
   ...
   * - {@link TaobaoRetrieveStarted 淘宝退款 > 开始商家挽回消息}
   */
  type TaobaoRetrieve = TaobaoRetrieveCompleted
    | TaobaoRetrieveStarted;
  /**
  ...
  type TaobaoShangou = TaobaoShangouRefundBuyerModifyAgreement
    ...
    | TaobaoShangouTradeMemoModified
